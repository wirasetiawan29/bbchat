...
extension MessageViewController: ImagePickerDelegate {
    public func didSelect(media: ImagePickerMediaType?) {
...
extension MessageViewController: MediaRecorderDelegate {
    public func didStartRecording(recorder: MediaRecorder) {
        /* do nothing */
    }

    public func didFinishRecording(recorder: MediaRecorder, url: URL?, duration: TimeInterval) {
        (self.inputAccessoryView as! SendMessageBar).audioPlaybackPreview(recorder.preview, duration: duration)
    }

    public func didUpdateRecording(recorder: MediaRecorder, amplitude: Float, atTime: TimeInterval) {
    ...
    public func didFailRecording(recorder: MediaRecorder, _ error: Error) {
