...
public final class Cache {
    ...
    public static let log = TinodeSDK.Log(subsystem: "co.tinode.tinodios")
    private var userId: String?
    private var token: Token?
    private var alreadyRegistered: Bool = false
    ...
    public static var token: Token? {
        return Cache.shared.token
    }
    
    public static var alreadyRegistered: Bool {
        return Cache.shared.alreadyRegistered
    }
    
    public static func setAlreadyRegistered(value: Bool) {
        Cache.shared.alreadyRegistered = value
    }
    
    public static func setToken(value: Token) {
        Cache.shared.token = value
    }
